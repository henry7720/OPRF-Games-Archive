...
function unblock(enteredUrl) {
  ...
  if (isValidUrl(enteredUrl)) {
    outputFrame.src = "http://equationsunblocker.ml/proxy.php?" + enteredUrl;
...
document.addEventListener("DOMContentLoaded", function() {
  if (window.location.protocol == "https:") {
    // Force HTTP, since the Proxy is HTTP
    window.location.href = "http://" + window.location.hostname.replace("www.", "") + window.location.pathname + window.location.search;
  }
